...
function Loginpage() {
  ...
  return (
    <div className="login-container flex items-center justify-center min-h-screen w-full relative">
      <ToastContainer />
      ...
      <div className="w-full max-w-md px-4 py-6 relative z-10">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="text-2xl sm:text-3xl font-medium text-indigo-600 mb-1">Welcome Back</div>
            <div className="text-base sm:text-lg text-gray-600 text-center">Log in to continue to ChatApp</div>
          </div>
          ...
          <div className="text-center text-gray-600 text-base sm:text-lg">
            Don't have account? <Link to="/signup"><span className="text-indigo-500 font-medium cursor-pointer">Sign Up</span></Link>
          </div>
        </div>
      </div>
    </div>
