            ...
            <div className="w-full max-w-xl px-4 py-6 relative z-10">
                <div className="bg-white bg-opacity-90 backdrop-filter backdrop-blur-md rounded-2xl shadow-xl p-6 sm:p-8">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <div className="text-2xl sm:text-3xl font-medium text-indigo-600 mb-1">Create Account</div>
                        <div className="text-base sm:text-lg text-gray-600 text-center">Sign up to join ChatApp</div>
                    </div>
                    ...
                    <div className="text-center text-gray-600 text-base sm:text-lg">
                        Already have an account? <Link to="/login"><span className="text-indigo-500 font-medium cursor-pointer hover:underline">Login</span></Link>
                    </div>
                </div>
            </div>
        </div>
